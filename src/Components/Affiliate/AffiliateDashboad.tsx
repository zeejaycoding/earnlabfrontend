        ...
        <div className="px-4 pb-6">
          ...
          {referralData && (
            <div className="mb-6 p-6 bg-gradient-to-br from-cyan-600 via-blue-600 to-purple-700 rounded-2xl shadow-2xl border border-cyan-500 border-opacity-30">
              <h3 className="text-white font-bold mb-3 text-xl">🔗 {t("affiliate.referral_link_title")}</h3>
              <p className="text-cyan-100 text-sm mb-4 opacity-95">
                {t("affiliate.referral_link_desc")}
              </p>
              ...
              <div className="mb-4 bg-slate-900 bg-opacity-40 rounded-lg p-3 border border-cyan-400 border-opacity-20">
                <p className="text-cyan-200 text-sm opacity-90">{t("affiliate.affiliate_code")}:</p>
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                >
                   {t("affiliate.share.twitter")}
                </button>
                <button
                  onClick={() => shareOnSocial("facebook")}
                  className="bg-slate-700 hover:bg-slate-600 text-cyan-300 px-3 py-2 rounded-lg text-sm font-medium transition border border-cyan-400 border-opacity-40"
                >
                  f {t("affiliate.share.facebook")}
                </button>
                <button
                  onClick={() => shareOnSocial("whatsapp")}
                  className="bg-slate-700 hover:bg-slate-600 text-cyan-300 px-3 py-2 rounded-lg text-sm font-medium transition border border-cyan-400 border-opacity-40"
                >
                  💬 {t("affiliate.share.whatsapp")}
                </button>
                <button
                  onClick={() => shareOnSocial("telegram")}
                  className="bg-slate-700 hover:bg-slate-600 text-cyan-300 px-3 py-2 rounded-lg text-sm font-medium transition border border-cyan-400 border-opacity-40"
                >
                  ✈️ {t("affiliate.share.telegram")}
                </button>
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 px-4 py-5 rounded-xl flex items-center gap-3 border border-cyan-500 border-opacity-30 shadow-lg hover:shadow-cyan-500/20 hover:shadow-2xl hover:border-cyan-400 hover:scale-105 hover:bg-gradient-to-br hover:from-cyan-900/40 hover:to-slate-700 transition-all duration-300 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm font-medium group-hover:text-white transition-colors">{t("affiliate.stats.available_claim")}</p>
              </div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 px-4 py-5 rounded-xl flex items-center gap-3 border border-blue-500 border-opacity-30 shadow-lg hover:shadow-blue-500/20 hover:shadow-2xl hover:border-blue-400 hover:scale-105 hover:bg-gradient-to-br hover:from-blue-900/40 hover:to-slate-700 transition-all duration-300 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm font-medium group-hover:text-white transition-colors">{t("affiliate.stats.pending_referrals")}</p>
              </div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 px-4 py-5 rounded-xl flex items-center gap-3 border border-purple-500 border-opacity-30 shadow-lg hover:shadow-purple-500/20 hover:shadow-2xl hover:border-purple-400 hover:scale-105 hover:bg-gradient-to-br hover:from-purple-900/40 hover:to-slate-700 transition-all duration-300 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm font-medium group-hover:text-white transition-colors">{t("affiliate.stats.total_referred")}</p>
              </div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 px-4 py-5 rounded-xl flex items-center gap-3 border border-green-500 border-opacity-30 shadow-lg hover:shadow-green-500/20 hover:shadow-2xl hover:border-green-400 hover:scale-105 hover:bg-gradient-to-br hover:from-green-900/40 hover:to-slate-700 transition-all duration-300 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm font-medium group-hover:text-white transition-colors">{t("affiliate.stats.total_earned")}</p>
              </div>
            </div>
          </div>
          ...
          {referralData && referralData.availableCents > 0 && (
            <div className="mb-6">
              ...
              >
                💰 {t("affiliate.claim_button1")} ${(referralData.availableCents / 100).toFixed(2)} {t("affiliate.claim_button2")}
              </button>
            </div>
          )}
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-lg">
            <h3 className="text-lg font-bold text-white mb-4">👥 {t("affiliate.referred_users_title")}</h3>

            <div className="text-center py-8 text-slate-400">
              <p>{t("affiliate.no_referred_users")}</p>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="px-4 pb-6 space-y-6">
          ...
          {referralData && (
            <div className="bg-gradient-to-br from-cyan-600 via-blue-600 to-purple-700 rounded-2xl shadow-2xl border border-cyan-500 border-opacity-30 p-6">
              <h3 className="text-white font-bold mb-3 text-xl">🔑 {t("affiliate.code_title")}</h3>
              <p className="text-cyan-100 text-sm mb-4 opacity-95">
                {t("affiliate.code_desc")}
              </p>
              ...
              {/* Referral Link */}
              <div className="mb-4 bg-slate-900 bg-opacity-40 rounded-lg p-3 border border-cyan-400 border-opacity-20">
                <p className="text-cyan-200 text-sm opacity-90 mb-2">{t("affiliate.referral_link_title")}:</p>
          ...
          {/* Earnings Stats */}
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-lg">
            <h3 className="text-lg font-bold text-white mb-4">📊 {t("affiliate.earnings_title")}</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-slate-700 to-slate-600 p-4 rounded-xl border border-cyan-500 border-opacity-30">
                <p className="text-cyan-300 text-sm font-medium mb-1">{t("affiliate.pending_earnings")}</p>
              ...
              <div className="bg-gradient-to-br from-slate-700 to-slate-600 p-4 rounded-xl border border-blue-500 border-opacity-30">
                <p className="text-blue-300 text-sm font-medium mb-1">{t("affiliate.pending_referrals")}</p>
              ...
              <div className="bg-gradient-to-br from-slate-700 to-slate-600 p-4 rounded-xl border border-green-500 border-opacity-30">
                <p className="text-green-300 text-sm font-medium mb-1">{t("affiliate.stats.total_earned")}</p>
        ...
        <div className="px-4 pb-6">
          <div className="mb-6">
            <span className="px-6 py-2 text-sm rounded-full bg-slate-700 text-cyan-300 font-medium border border-cyan-500 border-opacity-30">
              💡 {t("affiliate.tiers_info")}
            </span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {[
              { tier: 1, commission: 5, requirement: t("affiliate.tiers.default"), color: "border-cyan-500", hoverBg: "hover:from-cyan-900/40", hoverShadow: "hover:shadow-cyan-500/30", hoverBorder: "hover:border-cyan-400", textColor: "text-cyan-400" },
              { tier: 2, commission: 7, requirement: t("affiliate.tiers.tier2"), color: "border-blue-500", hoverBg: "hover:from-blue-900/40", hoverShadow: "hover:shadow-blue-500/30", hoverBorder: "hover:border-blue-400", textColor: "text-blue-400" },
              { tier: 3, commission: 10, requirement: t("affiliate.tiers.tier3"), color: "border-purple-500", hoverBg: "hover:from-purple-900/40", hoverShadow: "hover:shadow-purple-500/30", hoverBorder: "hover:border-purple-400", textColor: "text-purple-400" },
              { tier: 4, commission: 15, requirement: t("affiliate.tiers.tier4"), color: "border-green-500", hoverBg: "hover:from-green-900/40", hoverShadow: "hover:shadow-green-500/30", hoverBorder: "hover:border-green-400", textColor: "text-green-40₀" },
            ].map((tier) => (
              <div
                key={tier.tier}
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  />
                  <h3 className="text-lg font-bold text-white group-hover:text-slate-100">{t("affiliate.tiers.tier")} {tier.tier}</h3>
                </div>

                <hr className="border-slate-600 mb-4 group-hover:border-slate-500 transition-colors" />

                <div className="mb-4">
                  <p className="text-slate-300 text-sm font-medium mb-2 group-hover:text-white transition-colors">{t("affiliate.tiers.commission_rate")}:</p>
                ...
                <div>
                  <p className="text-slate-300 text-sm font-medium mb-2 group-hover:text-white transition-colors">{t("affiliate.tiers.requirement")}:</p>
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-lg">
            <h4 className="text-white font-bold mb-4 text-lg">📈 {t("affiliate.how_it_works")}:</h4>
            <ul className="text-slate-300 text-sm space-y-3">
              <li className="flex items-start gap-3">
                <span className="text-cyan-400 font-bold text-lg">✓</span>
                <span>{t("affiliate.steps.1")}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-400 font-bold text-lg">✓</span>
                <span>{t("affiliate.steps.2")}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-400 font-bold text-lg">✓</span>
                <span>{t("affiliate.steps.3")}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-green-400 font-bold text-lg">✓</span>
                <span>{t("affiliate.steps.4")}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-cyan-400 font-bold text-lg">✓</span>
                <span>{t("affiliate.steps.5")}</span>
              </li>
            </ul>
          </div>
        </div>
